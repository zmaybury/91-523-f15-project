...
$num_args = $#ARGV + 1;
if ($num_args != 8) {
    print "\nUsage: createFullTuningCNNFiles.pl example_dir data_dir train_root model_name num_samples learning_rate iterations num_classes\n";
    exit;
}
...
EXAMPLE=/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples
...
if(-d "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/"."$model_name"."_train_lmdb"){
	remove_tree("/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/"."$model_name"."_train_lmdb");
}
if(-d "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/"."$model_name"."_val_lmdb"){
	remove_tree("/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/"."$model_name"."_val_lmdb");
}
...
mkdir "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning" unless -d "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning";
mkdir "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples" unless -d "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples";
...
open(my $synset_words, '>', "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/synset_words.txt");
$labelCount = 0;
...
$solverText = "net: \""."$example_dir/FullTuning/$num_samples/"."train_val_"."$learning_rate"."_$iterations.prototxt\"
test_iter: 10
...
weight_decay: 0.0005
snapshot: "."$iterations"."
snapshot_prefix: \"$example_dir/FullTuning/$num_samples/"."$model_name"."_$learning_rate"."_$iterations"."_train"."\"
solver_mode: CPU";
open($fh, '>', "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/solver_"."$learning_rate"."_$iterations.prototxt");
print $fh "$solverText";
close $fh;
...
layer {
  ...
  data_param {
    source: \"$example_dir/FullTuning/$num_samples/"."$model_name"."_train_lmdb\"
    batch_size: 50
    backend: LMDB
  }
}
layer {
  ...
  data_param {
    source: \"$example_dir/FullTuning/$num_samples/"."$model_name"."_val_lmdb\"
    batch_size: 50
    backend: LMDB
  }
}
...
";
open($fh, '>', "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/train_val_"."$learning_rate"."_$iterations.prototxt");
...
open($fh, '>', "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/deploy.prototxt");
print $fh "$deployText";
close $fh;
...
$command = "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/caffe/tools/caffe train -solver=/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/solver_"."$learning_rate"."_$iterations.prototxt -weights=/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/bvlc_reference_caffenet.caffemodel";
system($command);

# (11) test caffe model
$command = "/Users/Zach/Desktop/GraduateWork/ComputerVision/Project/caffe/examples/cpp_classification/classification /Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/deploy.prototxt /Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/"."$model_name"."_$learning_rate"."_$iterations"."_train"."_iter_1000.caffemodel /Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/imagenet_mean.binaryproto /Users/Zach/Desktop/GraduateWork/ComputerVision/Project/CNNs/$example_dir/FullTuning/$num_samples/synset_words.txt /Users/Zach/Desktop/GraduateWork/ComputerVision/Project/datasets/"."$data_dir"."/$num_samples/test.txt $num_classes";
system($command);